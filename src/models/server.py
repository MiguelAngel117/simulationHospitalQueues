...
class Server1:
    ...
    def process_patients(self, patients, queue_2):
        for patient in patients:
            ...
            print(f"{patient.name} llega a la cola 1 a las {patient.arrival_time:.3f}, empieza a ser atendido a las {patient.start_time:.3f} y termina a las {patient.end_time:.3f}, tiempo servicio {patient.service_time1:.3f}, tiempo espera {patient.waiting_time:.3f} \n")
            self.log.append((patient.name, patient.arrival_time, patient.start_time, patient.end_time, patient.waiting_time))  # Actualizar log con tiempo de espera
...
class Server2:
    ...
    def process_patients(self, queue_2, queue_3):
        while True:
            ...
            self.log.append((patient_name, end_time_1, start_time_2, end_time_2, waiting_time_2))
...
class Server4:
    ...
    def process_patients(self, queue_3):
        while True:
            ...
            self.log.append((patient_name, end_time_2, start_time_3, end_time_3, waiting_time_3))
